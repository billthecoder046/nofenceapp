...
class JusticeTab1 extends StatefulWidget {
  final String category;
  JusticeTab1({Key? key, required this.category}) : super(key: key);

  @override
  _JusticeTab1State createState() => _JusticeTab1State();
}

class _JusticeTab1State extends State<JusticeTab1> {
